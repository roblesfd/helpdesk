...
const ClientProfileInfo = ({ userInfo }) => (
  <div>
    ...
    <p>
      <strong>Rol:</strong> {userInfo.roles}
    </p>
  </div>
);

const ClientProfileNotifications = ({ notifications }) => {
  return (
    <div>
      <p>ClientProfileNotifications</p>
    </div>
  );
};

const ClientProfileTickets = ({ tickets = [] }) => {
  return (
    <div className="px-4">
      <div className="flex justify-between items-center mb-4">
        ...
        <Link
          to="/mesa-de-ayuda"
          className="inline-block px-4 py-2 bg-indigo-500 text-white rounded-md hover:bg-indigo-600 transform transition-transform duration-300 ease-in-out hover:-translate-y-1"
        >
          Crear un ticket
        </Link>
      </div>
...
const ClientProfileSettings = ({ userInfo }) => {
  let initialValues = {
